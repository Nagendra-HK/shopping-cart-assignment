...
template.innerHTML = `
    ...
    <div class="container">
        <div class="header-left">
            <a href="./home.html"><img src="../../shopping-cart-assignment/static/images/logo.png" alt="Sabka Bazar logo"></a>
        ...
        <div class="right-section">
            ...
            <div>
                <a href="./cart.html" class="cart">
                    <img src="../../shopping-cart-assignment/static/images/cart.svg" alt="cart-logo" />
